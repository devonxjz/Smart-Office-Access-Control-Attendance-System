      ...
      <aside className="sticky top-0 hidden h-screen w-64 flex-col border-r border-sidebar-border bg-sidebar p-5 lg:flex">
        <Link to="/dashboard" className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-serif text-base font-semibold leading-tight text-sidebar-foreground">SmartOffice</p>
          </div>
        </Link>
              ...
              <Link
                ...
                className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors ${
                  active
                    ...
                    : "text-muted-foreground hover:bg-accent/50 hover:text-foreground font-semibold"
                }`}
              >
        ...
        <div className="rounded-lg border border-sidebar-border bg-card p-4 shadow-card">
          <div className="mb-2 flex items-center gap-2">
            <span className="relative flex h-2 w-2">
              <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-success opacity-75" />
              <span className="relative inline-flex h-2 w-2 rounded-full bg-success" />
            </span>
            <span className="font-mono text-xs font-medium">{t("system.online")}</span>
          </div>
        ...
        <button
          ...
          className="mt-3 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-muted-foreground hover:bg-destructive/10 hover:text-destructive transition-colors"
        >
      ...
      <div className="flex min-h-screen flex-1 flex-col">
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-border bg-background px-6">
          ...
          <button
            ...
            className="hidden sm:flex h-10 items-center gap-2 rounded-lg border border-border bg-card px-3 text-xs font-semibold hover:bg-accent cursor-pointer transition-colors"
          ...
          <button
            ...
            className="grid h-10 w-10 place-items-center rounded-lg border border-border bg-card hover:bg-accent cursor-pointer transition-colors"
          ...
          <div className="relative">
            <button
              ...
              className="relative grid h-10 w-10 place-items-center rounded-lg border border-border bg-card hover:bg-accent cursor-pointer transition-colors"
            >
            ...
            {openNotif && (
              <>
                ...
                <div className="absolute right-0 top-12 z-40 w-80 rounded-lg border border-border bg-popover p-2 shadow-card animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="space-y-1">
                    {notifications.map((n, i) => (
                      <div key={i} className="flex items-start gap-3 rounded-lg p-3 hover:bg-accent transition-colors">
                        <span
          ...
          {/* Avatar */}
          <div className="flex items-center gap-3 rounded-lg border border-border bg-card pl-3 pr-2 py-1.5 shadow-card transition-colors hover:bg-accent cursor-pointer">
          ...
          {searchPlaceholder && (
            <div className="mb-6 relative max-w-md">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-border bg-card pl-10 pr-3 text-sm outline-none transition-all focus:border-primary focus:ring-2 focus:ring-primary/20 focus:bg-card"
              />
            </div>
          )}
          {children}
